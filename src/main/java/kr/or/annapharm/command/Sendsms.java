...
public class Sendsms {
	...
	public static void sendSMS(String ph, String content) {
		...
		String accessKey = "accessKey"; // 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키 // Access Key :
													// https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key
													// ID
		String secretKey = "secretKey"; // 2차 인증을 위해 서비스마다 할당되는 service secret key //
																		// Service Key :
																		// https://www.ncloud.com/mypage/manage/info >
																		// 인증키 관리 > Access Key ID
		String serviceId = "ncp:sms:kr:.....:sens_test"; // 프로젝트에 할당된 SMS 서비스 ID // service ID :
		...
		bodyJson.addProperty("from", "tel"); // Mandatory, 발신번호, 사전 등록된 발신번호만 사용 가능
